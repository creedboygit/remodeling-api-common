package com.hanssem.remodeling.common.common.error;
...
public final class CustomException extends RuntimeException{
    ...
    public static CustomException fromHanssemMallApi(final int errorCode, final String msg) {
        return new CustomException(errorCode, String.format("[HanssemMall API Error] : %s", msg));
    }
