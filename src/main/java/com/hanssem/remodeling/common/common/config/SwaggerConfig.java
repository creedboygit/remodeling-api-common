...
public class SwaggerConfig {
    ...
    public GroupedOpenApi adminOpenApi(@Value("${springdoc.version}") String appVersion) {
        String[] paths = { "/admin/**" };
        String[] packages = {"com.hanssem.remodeling.common.admin"};
    ...
    public GroupedOpenApi usersOpenApi(@Value("${springdoc.version}") String appVersion) {
        String[] paths = { "/api/**" };
        String[] packages = {"com.hanssem.remodeling.common.api"};
        return GroupedOpenApi.builder().group("users")
            .addOpenApiCustomiser(openApi -> openApi.info(new Info().title("Remodeling User API").version(appVersion)))
            .pathsToMatch(paths)
            .packagesToScan(packages)
            .build();
    }
    ...
    public OpenAPI openAPI() {
        ...
        apiDoc.addSecurityItem(new SecurityRequirement().addList("Authorization"))
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("co.edithome.common.controller"))
